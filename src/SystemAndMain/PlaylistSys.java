		 ...
		 for(Playlist p : playlists)
		 {
			 for (int i = 0; i < p.getItems().size(); i++) {
				 if (p.getItems().get(i) instanceof Song) {
				     ...
				     fw.write("song___" + song.getArtist().getFirstName() + "___" + song.getArtist().getLastName() + "___" + song.getArtist().getStageName() + "___" + song.getTitle() + "___" + song.getReleaseDate() + "___" + song.getDuration().getHr() + "___" + song.getDuration().getMin() + "___" + song.getDuration().getSec() + "___" + song.getLanguage() + "___" + song.getGenre() + "___" + song.getCover() + "\n");				        
				 } else if (p.getItems().get(i) instanceof Podcast) {
					 Podcast podcast = (Podcast) p.getItems().get(i);
					 fw.write("podcast___" + podcast.getHost() + "___" + podcast.getDesc() + "___" + podcast.getEpisodes() + "___" + podcast.getTitle() + "___" + podcast.getReleaseDate() + "___" + podcast.getDuration().getHr() + "___" + podcast.getDuration().getMin() + "___" + podcast.getDuration().getSec() + "___" + podcast.getLanguage() + "___" + podcast.getGenre() + "___" + podcast.getCover() + "\n");			 
				 } else {
					 AudioBook ab = (AudioBook) p.getItems().get(i);
					 fw.write("audiobook___" + ab.getAuthor() + "___" + ab.getChapters() + "___" + ab.getTitle() + "___" + ab.getReleaseDate() + "___" + ab.getDuration().getHr() + "___" + ab.getDuration().getMin() + "___" + ab.getDuration().getSec() + "___" + ab.getDuration().getSec() + "___" + ab.getLanguage() + "___" + ab.getGenre() + "___" + ab.getCover() + "\n");
					 
				 }
				 
			}
			fw.write(p.getDuration().getHr() + "___" + p.getDuration().getMin() + "___" + p.getDuration().getSec() + "___" + p.getCreationDate() + "___" + p.getItemAmount() + "___" + p.getTitle() + "___" + p.getCover() + "\nend\n");
		 }
		 fw.close();
	 }
